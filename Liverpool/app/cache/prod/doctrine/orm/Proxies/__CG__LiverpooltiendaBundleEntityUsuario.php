 ...
 */
class Usuario extends \Liverpool\tiendaBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Usuario' . "\0" . 'idusuario', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Usuario' . "\0" . 'usuario', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Usuario' . "\0" . 'contrasena', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Usuario' . "\0" . 'idpersona'];
        }
