 ...
 */
class User extends \Liverpool\tiendaBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\User' . "\0" . 'idusuario', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\User' . "\0" . 'usuario', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\User' . "\0" . 'contrasena', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\User' . "\0" . 'idpersona'];
        }
