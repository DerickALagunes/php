 ...
 */
class Tipouser extends \Liverpool\tiendaBundle\Entity\Tipouser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Tipouser' . "\0" . 'idtipouser', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Tipouser' . "\0" . 'tipo', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Tipouser' . "\0" . 'idpersona', '' . "\0" . 'Liverpool\\tiendaBundle\\Entity\\Tipouser' . "\0" . 'idusuario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tipouser $proxy) {
    ...
    public function getIdtipouser()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdtipouser();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdtipouser', []);

        return parent::getIdtipouser();
    }
